...
export function useStudentProfileController() {
  ...
  const derived = useStudentProfileDerivedState({
  ...
  const academic = useStudentProfileAcademicHandlers({
    ...state,
  ...
  const appearance = useStudentProfileAppearanceHandlers({
    languagePreference,
    refreshUser,
  ...
  const personalization = useStudentProfilePersonalizationHandlers({
    currentNotificationPreferences: derived.currentNotificationPreferences,
    currentPersonalization: derived.currentPersonalization,
    setNotificationPrefs: state.setNotificationPrefs,
    setPersonalization: state.setPersonalization,
    t,
    toast,
  });
  const account = useStudentProfileAccountHandlers({
    closeDeleteDialog: deleteDialog.closeDeleteDialog,
    deletePassword: deleteDialog.deletePassword,
    logout,
    navigate,
    t,
    toast,
