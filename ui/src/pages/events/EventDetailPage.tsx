...
type EventDetailTexts = ReturnType<typeof useI18n>['t'];
...
type EventOverviewProps = Readonly<{
  event: EventDetail;
  isPast: boolean;
  isFull: boolean;
...
function EventOverview({ event, isPast, isFull, language, t }: EventOverviewProps) {
  return (
      ...
      <div className="relative mb-6 aspect-video overflow-hidden rounded-xl bg-muted">
        {event.cover_url ? (
          <img
            ...
            onError={(eventTarget) => {
              (eventTarget.target as HTMLImageElement).src =
...
export function EventDetailPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid gap-8 lg:grid-cols-3">
        <EventOverview event={event} isPast={isPast} isFull={isFull} language={language} t={t} />
        <EventSidebar
          event={event}
          isPast={isPast}
          isFull={isFull}
          ...
          onResendRegistrationEmail={handleResendRegistrationEmail}
          onFavorite={handleFavorite}
          onShare={handleShare}
          onExportCalendar={handleExportCalendar}
          onClone={handleClone}
          onHideTagIdChange={setHideTagId}
